...
export default function Home() {
  ...
  const activeSlide = carouselArticles[carouselIndex]
  ...
  return (
    <div className="space-y-8 pb-10 md:space-y-10">
      <section className="w-full">
        <div className="relative h-64 sm:h-80 md:h-[380px] lg:h-[430px]">
          <img
          ...
          <div className="absolute inset-0">
            <div className="container flex h-full flex-col justify-between py-4 md:py-8">
              ...
              <div className="mt-4 hidden flex-col items-end gap-3 md:mt-6 md:ml-auto md:flex">
                <div className="flex flex-wrap justify-end gap-2">
                  <button
                    type="button"
                    onClick={() =>
                      navigate(`/مقال/${encodeURIComponent(activeSlide.slug)}`)
                    }
            ...
            <div className="absolute bottom-4 right-4 flex flex-col items-end gap-3 md:hidden">
              <div className="flex flex-wrap justify-end gap-2">
                <button
                  type="button"
                  onClick={() =>
